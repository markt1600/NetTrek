...
function updateHud(world) {
  ...
  // Two states:
  //   PROCEEDING — autopilot in transit to a capture target (blue, no bar)
  //   CAPTURING — orbit lock + hold sequence (orange, bar fills)
  ...
  if (capBanner) {
    ...
    if (mode && planet) {
      ...
      capBanner.classList.remove("pending", "stalled");
    }
  }
